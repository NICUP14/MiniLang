...
* split_int8ptr_int8ptr_int32ptr(char* split_int8ptr_int8ptr_int32ptr_cs, char* split_int8ptr_int8ptr_int32ptr_sep, int* split_int8ptr_int8ptr_int32ptr_cnt) { 
  ...
  if (split_int8ptr_int8ptr_int32ptr_arr == (void*)0) {
          printf("%s\n", "Cannot split string.");
    printf("Panicked in function %s, %s:%lld\n", "split_int8ptr_int8ptr_int32ptr", "../../../include/stdlib/string.ml", 193);
    exit(1);
    }
...
* split_sds_sds_int32ptr(sds split_sds_sds_int32ptr_s, sds split_sds_sds_int32ptr_sep, int* split_sds_sds_int32ptr_cnt) { 
  ...
  if (split_sds_sds_int32ptr_arr == (void*)0) {
          printf("%s\n", "Cannot split string.");
    printf("Panicked in function %s, %s:%lld\n", "split_sds_sds_int32ptr", "../../../include/stdlib/string.ml", 205);
    exit(1);
    }
...
* split_sds_int8ptr_int32ptr(sds split_sds_int8ptr_int32ptr_s, char* split_sds_int8ptr_int32ptr_sep, int* split_sds_int8ptr_int32ptr_cnt) { 
  ...
  if (split_sds_int8ptr_int32ptr_arr == (void*)0) {
          printf("%s\n", "Cannot split string.");
    printf("Panicked in function %s, %s:%lld\n", "split_sds_int8ptr_int32ptr", "../../../include/stdlib/string.ml", 217);
    exit(1);
    }
...
sds start_file_rangeref(file_range* start_file_rangeref_arg) { 
  if ((*start_file_rangeref_arg).file_range_succ == false) {
    ...
    printf("Panicked in function %s, %s:%lld\n", "start_file_rangeref", "../../../include/stdlib/builtin/for.ml", 69);
    exit(1);
    }
...
long long score_int8_int8(char score_int8_int8_ch, char score_int8_int8_ch2) { 
  long long score_int8_int8_t[9];
  (score_int8_int8_t[0] = 4);
  (score_int8_int8_t[1] = 1);
  (score_int8_int8_t[2] = 7);
  (score_int8_int8_t[3] = 8);
  (score_int8_int8_t[4] = 5);
  (score_int8_int8_t[5] = 2);
  (score_int8_int8_t[6] = 3);
  (score_int8_int8_t[7] = 9);
  (score_int8_int8_t[8] = 6);
  return score_int8_int8_t[(((score_int8_int8_ch - 'A') * 3) + (score_int8_int8_ch2 - 'X'))];
}

void part_one_FILEptr(FILE* part_one_FILEptr_st) { 
  long long part_one_FILEptr_sum = 0;
  char* part_one_FILEptr_cs = (void*)0;
  file_range part_one_FILEptr_for20_target = iter_file_range(lines_FILEptr(part_one_FILEptr_st));
  sds part_one_FILEptr_ln = start_file_rangeref((&part_one_FILEptr_for20_target));
  for (;(false != stop_file_rangeref((&part_one_FILEptr_for20_target)));(part_one_FILEptr_ln = next_file_rangeref((&part_one_FILEptr_for20_target)))) {
  (part_one_FILEptr_ln = trim_sds_int8ptr(part_one_FILEptr_ln, "\n"));
  (part_one_FILEptr_cs = c_str_sds(part_one_FILEptr_ln));
  (part_one_FILEptr_sum = (part_one_FILEptr_sum + score_int8_int8(part_one_FILEptr_cs[0], part_one_FILEptr_cs[2])));;;
    }
  _print_FILEptr_int8ptr((FILE*)stdout, "Part one: ");
  _print_FILEptr_int64((FILE*)stdout, part_one_FILEptr_sum);
  puts("");
}
...
int main() { 
  ...
  FILE* main_in_file = open_file_int8ptr("input.txt");
  part_one_FILEptr(main_in_file);
  gc_stop((&ml_gc));
  if (main_in_file != (void*)0) {
          fclose(main_in_file);
    (main_in_file = (void*)0);
    }
  return 0;
